...
\title{Medical LLM Self-Preference}
\author{
  ...
  \small 301 Platt Boulevard, Claremont, CA 91711, USA.
}
\date{August 2026}
...
Real-POCQi source revision \cite{feng2026}. All eight models generated one answer per question,
...
The multi-turn experiment uses the role-separated MedSP1000 dataset
\cite{liang2026}. A
...
\bibitem{feng2026}
Feng, J., Patel, V., Heagerty, P., Mai, Y., Sivaraman, V., Vossler, P.,
Ouyang, J., and Jena, A. B. (2026).
Expert Evaluation of Clinical AI Tools on Real Point-of-Care Clinical Queries.
\emph{arXiv preprint arXiv:2606.28960}.

\bibitem{liang2026}
Liang, C., Qiu, P., Zhang, Y., Wang, Y., Wu, C., and Xie, W. (2026).
Evaluating Large Language Models in Dynamic Clinical Decision-Making with
Standardized Patient Cases. \emph{arXiv preprint arXiv:2606.05112}.
